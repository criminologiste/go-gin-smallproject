...
func AddArticle(c *gin.Context) {
	...
	state := com.StrTo(c.DefaultQuery("state", "0")).MustInt() //c.DefaultQuery 提供了默认值参数
	...
	valid.Range(state, 0, 1, "state").Message("状态只允许0或者1") //valid.Range 提供了最大值和最小值的参数
